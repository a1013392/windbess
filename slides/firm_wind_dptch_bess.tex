...
\author[S.~Tarca]{Silvio Tarca\inst{a} }
\institute[]{
	\inst{a}
...
\date[July 2018]{Prepared for Tilt Renewables\\July 2018}
\subject{}
...
\note[item]{
This research is funded by the ARC Centre of Excellence for Mathematical \& Statistical Frontiers 
}
\note[item]{
We acknowledge the support of Tilt Renewables who have granted the University of Adelaide access to their confidential unconstrained intermittent generation forecasts 
}
\end{frame}
\usebackgroundtemplate{}
...
\footnotetext[3]{Australian Energy Regulator (Oct.~2016).  Electricity spot prices above \$5000/MWh: South Australia, 13 July 2016.
}
\par
}
...
\footnotetext[4]{Dr Alan Finkel, Chief Scientist, Chair of the Expert Panel, Ms Karen Moses, Ms Chloe Munro, Mr Terry Effeney, Professor Mary O'Kane (June 2017).  Independent review into the future security of the National Electricity Market: Blueprint for the future.
}
\footnotetext[5]{Australian Energy Market Operator (Dec.~2016).  National transmission network development plan.
}
\par
}
...
%\begin{frame}
%	\frametitle{\large Snowtown wind farm (1.0 p.u.) coupled with a utility-scale battery}
%	\framesubtitle{Curtailment of scheduled power depends on generation capacity and battery state of charge}
%
%	\begin{figure}[!h]
%		\centering
%    		\label{fig:disp_wind_bess}
%		\scalebox{0.75}{
%			\input{plot_wind_bess_nmae_curtgen}
%		}
%	\end{figure}
%
%\end{frame}
