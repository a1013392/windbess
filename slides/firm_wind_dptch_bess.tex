...
\date[June 2018]{Prepared for Tilt Renewables\\June 2018}
\subject{}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item  Choose 99MW (nominal capacity of the Snowtown Stage 1) as the base quantity for power, i.e., nominal capacity of Snowtown Stage 1 is 1.0 p.u. 
			\item  For simplicity choose 99MWh as the base quantity for energy, e.g., battery with energy capacity of 49.5MWh translates to 0.5 p.u.
			\item  Fix power rating of battery to 0.8 times its energy capacity, e.g., battery with energy capacity of 0.5 p.u.\ has a power rating of 0.4 p.u.
		\end{itemize}
...
\begin{frame}
	...
	{\scriptsize \textit{Battery with energy capacity 0.25 p.u.\ coupled to Snowtown wind farm with nominal capacity 1.0 p.u.\\Battery SOC bounded from below (12.5\% of energy capacity) and above (87.5\%)}
	\par
	}
